...
export default function CreateProduct() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const res = await fetch("https://ruwa-backend.onrender.com/api/v1/showAllCategory");
  ...
  useEffect(() => {
    const fetchVariants = async () => {
      try {
        const res = await fetch("https://ruwa-backend.onrender.com/api/v1/totalVariation");
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchBrands = async () => {
      try {
        const res = await fetch("https://ruwa-backend.onrender.com/api/v1/totalBrands");
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchUnits = async () => {
      try {
        const res = await fetch("https://ruwa-backend.onrender.com/api/v1/totalUnit");
        const data = await res.json();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://ruwa-backend.onrender.com/api/v1/createProduct", {
        method: "POST",
        headers: {
